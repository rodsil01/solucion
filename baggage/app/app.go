...
import (
	...
	eventconfig "github.com/rodsil01/solucion-apuesta-total/baggage/app/event-config"
	handlerconfig "github.com/rodsil01/solucion-apuesta-total/baggage/app/handler-config"
...
func Start() {
	...
	handlerConfig.AddBaggageHandlers(router)
